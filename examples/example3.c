...

  {
    if (((n) < 2))
    {
    ...
    } else {
      {
        signed int x, y;;
        ((x) = ({
          signed int _tmp14_0 = ((n) - 1);;
          ((printf)("example3.xc:10:6: calling fib(%s)\n", (((showInt)((_tmp14_0))).text)));
          signed int _tmp14_result = ((fib)((_tmp14_0)));;
          ((printf)("example3.xc:10:6: returning fib(%s) = %s\n", (((showInt)((_tmp14_0))).text), (((showInt)((_tmp14_result))).text)));
          (_tmp14_result); })
        );
        ((y) = ({
          signed int _tmp16_0 = ((n) - 2);;
          ((printf)("example3.xc:11:6: calling fib(%s)\n", (((showInt)((_tmp16_0))).text)));
          signed int _tmp16_result = ((fib)((_tmp16_0)));;
          ((printf)("example3.xc:11:6: returning fib(%s) = %s\n", (((showInt)((_tmp16_0))).text), (((showInt)((_tmp16_result))).text)));
          (_tmp16_result); })
        );
        return ((x) + (y));
      }
...
signed int main(signed int  argc, char  * argv[])
{

  {
    ...
    ((printf)("Result: %d\n", ({
      signed int _tmp17_0 = ((atoi)(((argv)[1])));;
      ((printf)("example3.xc:23:24: calling fib(%s)\n", (((showInt)((_tmp17_0))).text)));
      signed int _tmp17_result = ((fib)((_tmp17_0)));;
      ((printf)("example3.xc:23:24: returning fib(%s) = %s\n", (((showInt)((_tmp17_0))).text), (((showInt)((_tmp17_result))).text)));
      (_tmp17_result); })
    ));
    return 0;
  }
